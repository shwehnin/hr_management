...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        \Illuminate\Support\Facades\DB::table('permission_lists')->insert([
            ['permission_name' => 'Holidays', 'read' => 'Y', 'write' => 'Y', 'create' => 'Y', 'delete' => 'Y', 'import' => 'Y', 'export' => 'Y'],
            ...
            ['permission_name' => 'Project', 'read' => 'Y', 'write' => 'N', 'create' => 'N', 'delete' => 'N', 'import' => 'N', 'export' => 'N'],
            ...
            ['permission_name' => 'Timing Sheet', 'read' => 'Y', 'write' => 'Y', 'create' => 'Y', 'delete' => 'Y', 'import' => 'N', 'export' => 'N'],
        ]);
    }
